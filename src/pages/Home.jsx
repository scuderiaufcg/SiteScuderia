        ...
        <div className="flex items-center justify-center px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <p className="text-black w-[850px] max-w-full text-justify text-4xl leading-relaxed">
              O <strong>Scuderia UFCG</strong> surgiu da vontade de alunos de fazer com que o
              departamento de Engenharia Mecânica competisse na categoria Formula SAE.
              <br /><br />
              Um grupo de alunos no ano de 2013, com auxílio do professor
              Juscelino de Farias Maribondo deram início à fase de fundação do projeto.
            </p>
            </div>
          </div>
        </section>
        <section>
          <h5 className=" text-black text-center text-4xl font-semibold mb-12 max-w-4xl mx-auto">RESULTADOS</h5>
           <p className=" text-black max-w-4xl mx-auto text-4xl leading-relaxed text-center px-4">
            2015: Primeira participação do FASE apresentando apenas os relatórios do projeto.<br />
            2016: 26ª posição.<br />
            2017: 27ª posição.<br />
            2018: 24ª posição.<br />
